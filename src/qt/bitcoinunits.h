...
/** Zevno unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ZevnoUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ZevnoUnits(QObject *parent);
...
typedef ZevnoUnits::Unit ZevnoUnit;
