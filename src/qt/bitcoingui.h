...
/**
  Zevno GUI main class. This class represents the main window of the Zevno UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ZevnoGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit ZevnoGUI(QWidget *parent = 0);
    ~ZevnoGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a Zevno  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
