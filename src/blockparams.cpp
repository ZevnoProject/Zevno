...
//
//
// Reward calculations for 25-years of ZEV emissions
// 10 Billion Total     | 8 Billion Premine
// 100% Remaining ZEV   : 2,000,000,000
// ----------------------------------
...
// Payout per block     : 300 ZEV
// Payout per day       : 300 * ((1 * 60 * 60) / (2 * 60) * 24)                   =       216,000 ZEV
// Payout per month     : 300 * (((1 * 60 * 60) / (2 * 60) * 24) * 30)            =     6,480,000 ZEV
// Payout per year      : 300 * (((1 * 60 * 60) / (2 * 60) * 24) * 365)           =    78,840,000 ZEV
// Mineout              : 300 * (25.36 * (((1 * 60 * 60) / (2 * 60) * 24) * 365)) = 2,000,000,000 ZEV
// ----------------------------------
// (Network Allocation) (BLOCKS | 25-Years of minting)
// Singular Payout      : 150-->50 ZEV
// Maternode Payout     : 100-->200 ZEV
// DevOps Payout        : 50 ZEV
// ----------------------------------
// (PLEASE NOTE)
...
{
    int64_t ret2 = 0;
    ret2 = 0.05 * COIN; // 0.05 ZEV per block = 2% of blocks.
