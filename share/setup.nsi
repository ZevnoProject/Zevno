...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin" "" "URL:Zevno"
    #    WriteRegStr HKCR "bitcoin\DefaultIcon" "" $INSTDIR\bitcoin-qt.exe
    #    WriteRegStr HKCR "bitcoin\Zevno\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section -un.post UNSEC0001
    ...
    #Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Zevno.lnk"
    #Delete /REBOOTOK "$SMSTARTUP\Zevno.lnk"
